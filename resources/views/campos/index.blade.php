...
@section('content')
    ...
    <button type="button" class="btn btn-success mb-3 btn-crear" data-bs-toggle="modal" data-bs-target="#modal-formulario">
        <i class="fa-solid fa-duotone fa-plus"></i> Crear campo</button>

    <h2 class="text-info fw-bold">Lista de campos (SIE)</h2>
    ...
    @include('campos.modal_form')
@endsection

@section('scripts')
    @include('campos.index_scripts')
@endsection
