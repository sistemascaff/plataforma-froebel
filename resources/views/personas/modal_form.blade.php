<!-- Modal para crear y editar personal -->
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label for="documento_complemento"
                                        class="form-label fw-semibold">Complemento</label>
                                    <input type="text" class="form-control" id="documento_complemento"
                                        name="documento_complemento" maxlength="10">
                                </div>
                                <div class="col-md-3">
                                    <label for="documento_expedido" class="form-label fw-semibold">Expedido <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <label for="tipo_perfil" class="form-label fw-semibold">Tipo de perfil <span
                                            class="text-danger">*</span></label>
