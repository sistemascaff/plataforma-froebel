        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-crear-o-editar">
                    <!-- input de id_periodo en caso de editar -->
                    <input type="hidden" name="id_periodo" value="0">

                    <div class="mb-3">
                        <label for="periodo" class="form-label">Periodo <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="periodo" name="periodo" min="3" required>
                    </div>
