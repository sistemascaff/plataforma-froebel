        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-crear-o-editar">
                    <!-- input de id_area en caso de editar -->
                    <input type="hidden" name="id_area" value="0">

                    <div class="mb-3">
                        <label for="area" class="form-label">Área <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="area" name="area" min="3" max="100" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="campo" name="id_campo" required>
                            <option value="" disabled selected>Seleccione un campo</option>
                            @foreach ($campos as $campo)
                                <option value="{{ $campo->id_campo }}">{{ $campo->campo }}</option>
                            @endforeach
                        </select>
                    </div>
                </form>
